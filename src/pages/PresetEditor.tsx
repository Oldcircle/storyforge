          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              <Field label="导演系统提示词" hint="使用 {{characters}} 和 {{scenes}} 占位符注入角色和场景信息">
                <textarea
                  className="min-h-[400px] font-mono w-full rounded-xl border border-stroke bg-bg-tertiary px-4 py-2.5 hover:border-stroke-strong text-sm text-text-primary placeholder:text-text-muted outline-none transition focus:border-accent-blue focus:ring-2 focus:ring-accent-blue/10"
